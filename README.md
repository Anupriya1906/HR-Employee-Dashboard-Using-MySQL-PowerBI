...
### SQL Scripts
I haven't use records where the age was negative (967 records), and only looked at ages 18 and older. Also, haven't include records with termination dates way in the future (1599 records). I only considered termination dates that are on or before the current date.
